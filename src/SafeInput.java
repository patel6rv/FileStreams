...
public class SafeInput 
{
   ...
   public static boolean checkNonZeroLenStr(String input)
   {
       if (input.length() == 0)
       {
           JOptionPane.showMessageDialog(null, "Please enter a value for your missing field(s)");
           return false;
       }
       return true;
   }
...
/**
    ...
    public static boolean checkDouble(String input)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Please enter a double value for cost. You entered: " + input);
            check = false;
        }
